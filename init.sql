...
(
	PROBLEM_ID NVARCHAR(8) PRIMARY KEY,
    NAME NVARCHAR(30),
...
(
	TESTCASE_ID NVARCHAR(8) PRIMARY KEY,
    INPUT NVARCHAR(100),
    OUTPUT NVARCHAR(4000),
	CREATEDAT DATETIME,
    UPDATEDAT DATETIME,
    PROBLEMID NVARCHAR(8)
);
CREATE TABLE SUBMITDETAILS
(
	SUBMITID NVARCHAR(8),
    TESTCASESID NVARCHAR(8),
    TIME FLOAT,
    STATE INT,
...
(
	SUBMIT_ID NVARCHAR(8) PRIMARY KEY,
    CODE NVARCHAR(4000),
...
INSERT INTO SUBMISSIONS(SUBMIT_ID, CODE, LANGUAGE, STATE, CREATEDAT, UPDATEDAT, USERID)
VALUES('SUB_01', '#include<iostream> using namespace std;int main(){int a, b;cin >> a >> b;cout << a + b;return 0;}', 'cpp', 0, '2022-09-18', NULL, 'U_01');
INSERT INTO SUBMISSIONS(SUBMIT_ID, CODE, LANGUAGE, STATE, CREATEDAT, UPDATEDAT, USERID)
VALUES('SUB_02', '#include<iostream> using namespace std;int main(){int a, b;cin >> a >> b;cout << a + b;return 0;}', 'cpp', 1, '2022-09-18', NULL, 'U_02');
INSERT INTO SUBMISSIONS(SUBMIT_ID, CODE, LANGUAGE, STATE, CREATEDAT, UPDATEDAT, USERID)
VALUES('SUB_03', '#include<iostream> using namespace std;int main(){int a, b;cin >> a >> b;cout << a + b;return 0;}', 'cpp', 0, '2022-09-18', NULL, 'U_02');
INSERT INTO SUBMISSIONS(SUBMIT_ID, CODE, LANGUAGE, STATE, CREATEDAT, UPDATEDAT, USERID)
VALUES('SUB_04', '#include<iostream> using namespace std;int main(){cout<<"Hello World!!";return 0;}', 'cpp', 0, '2022-09-18', NULL, 'U_02');
INSERT INTO SUBMISSIONS(SUBMIT_ID, CODE, LANGUAGE, STATE, CREATEDAT, UPDATEDAT, USERID)
VALUES('SUB_05', '#include<iostream> using namespace std;int main(){cout<<"Hello World!!";return 0;}', 'cpp', 1, '2022-09-18', NULL, 'U_01');
...
BEGIN
	...
	INNER JOIN PROBLEMS
	ON PROBLEMS.PROBLEM_ID = TESTCASES.PROBLEMID
	WHERE SUBMISSIONS.STATE != '0' AND USERS.USER_ID = UserID
